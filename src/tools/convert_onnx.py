...
# ================= CẤU HÌNH TRỰC TIẾP =================
CKPT_PATH: str = "outputs/train/v5.resnet50.cia+cia_gen/weights/best-epoch=33-val_f1_macro=0.404.ckpt"
OUTPUT_PATH: str = "outputs/convert_onnx/v5.resnet50.cia+cia_gen.onnx"
...
model = MultiLabelClassifyModel.load_from_checkpoint(
    CKPT_PATH, model=backbone, map_location="cpu"
)
model.eval()
